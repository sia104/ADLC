...
- When an ADLC evidence run is active, record traceability, test results, gaps,
  and runtime findings through the shared `.adlc` mechanism. This evidence write
  does not authorize product or test changes.
